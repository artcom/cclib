...
# macro(STRINGIFY_SHADERS SOURCES)
#   foreach(FILE ${ARGN})
#     set(INPUT ${CMAKE_CURRENT_SOURCE_DIR}/shaders/${FILE})
#     set(OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/shaders/${FILE})
...
# endmacro(STRINGIFY_SHADERS SOURCES)
# 
...
function(STRINGIFY_SHADERS FILENAME)
    set(INPUT ${CMAKE_CURRENT_SOURCE_DIR}/shaders/${FILENAME})
    set(OUTPUT ${CMAKE_CURRENT_SOURCE_DIR}/stringified_shaders/${FILENAME})
    set(OUTPUT_FILES ${OUTPUT}.h ${OUTPUT}.cpp)
